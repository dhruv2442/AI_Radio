import 'package:al_radio/models/radio.dart';
import 'package:al_radio/utils/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "29127945288337d8d640817f621cfc472e956eca572e1d8b807a3e2338fdd0dc/stage",
                          ...
                          Align(
                              ...
                              child: [
                                Icon(CupertinoIcons.play_circle,
                                    color: Colors.white),
                                10.heightBox,
                                "Doble tap to pay".text.gray300.make()
                              ].vStack())
                        ],
                      ),
                    )
